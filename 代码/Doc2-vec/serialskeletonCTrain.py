...
df = df.sample(n=550000)
train, test = train_test_split(df, test_size=0.09, random_state=42)
test.to_csv("Testload.csv")
second=[]
timspans=[]
Test_sample=[100000,150000,200000,250000,300000,350000,450000,500000]
iter=0
...
plt.legend()
plt.show();
OutPath = '/lustre/home/d171/s1926539/dissertation/s1926539/Data_code/Dissertationcode/'
